...
@section('content')
    <main>
      ...
      <section class="bg-gray-900 p-10 flex flex-col gap-10">
        ...
        <form method="post" action="{{route('question.post', ['category', $category])}}" class="flex flex-col bg-gray-800 rounded-lg p-6 gap-[2rem]">
          @csrf
          @method('post')
          ...
          />
          <textarea name="desc" cols="28" rows="2" placeholder="Description"
                      class="bg-transparent placeholder:text-white placeholder:capitalize text-white focus:outline focus:outline-1 focus:outline-yellow-500 px-2 py-3 rounded-lg"
          ></textarea>
