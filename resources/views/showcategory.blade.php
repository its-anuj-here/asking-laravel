              ...
              <div class="flex gap-10">
                <article class="flex flex-col gap-3 question">
                  <h3 class="text-2xl text-yellow-500 font-semibold flex flex-col gap-2 justify-between">
                    <a href="./query.php?queryid='.$id.'" class="cursor-pointer">Query : {{$question->que_title}}</a>
                    <span class="text-sm text-white">By user <strong class="text-green-500">{{$question->by_username}}</strong> on {{$question->posted_at}}</span>
                  </h3>
