      ...
      >
        <div class="p-4 md:w-1/3 flex flex-col text-center items-center">
          ...
          <div class="flex-grow">
            ...
            <p class="leading-relaxed text-base">
              ...
              We put a lot of effort in making it more appealing as well as smooth for devices.
            </p>
        ...
        <div class="p-4 md:w-1/3 flex flex-col text-center items-center">
          ...
          <div class="flex-grow">
            ...
            <p class="leading-relaxed text-base">
            Depending on which user answers you, there are a variety of answers provided to your needs.
            This questioning allows you to get knowledge from available users across website.
            </p>
            <a class="mt-3 text-yellow-400 inline-flex items-center"
              >Learn More
              <svg
        ...
        <div class="p-4 md:w-1/3 flex flex-col text-center items-center">
          ...
          <div class="flex-grow">
            ...
            <p class="leading-relaxed text-base">
              We have a vast varity of users, which helps users to get there queries answered in short period of time.
